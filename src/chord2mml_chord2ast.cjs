...
function peg$parse(input, options) {
  ...
  var peg$f62 = function() { return { event: "inline mml", mml: "@48" }; };
  var peg$f63 = function() { return { event: "inline mml", mml: "@49" }; };
  var peg$f64 = function() { return { event: "inline mml", mml: "@52" }; };
  var peg$currPos = 0;
  var peg$savedPos = 0;
