...
var require_chord2mml_chord2ast = __commonJS({
  "src/chord2mml_chord2ast.cjs"(exports, module) {
    "use strict";
...
// src/chord2mml.ts
var import_chord2mml_chord2ast = __toESM(require_chord2mml_chord2ast());
...
// src/chord2mml.ts
var chord2mml = { parse: import_chord2mml_chord2ast.parse };
chord2mml.parse = function(chord) {
  let ast = (0, import_chord2mml_chord2ast.parse)(chord);
  ast = astToAst(ast);
